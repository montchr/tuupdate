...
<div class="comment__body  media__body">
  ...
  <time datetime="<?php echo comment_date('c'); ?>"><a href="<?php echo htmlspecialchars(get_comment_link($comment->comment_ID)); ?>" class="smallprint"><?php printf(__('%1$s', 'exai'), get_comment_date(),  get_comment_time()); ?></a></time>
