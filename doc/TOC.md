[Roots Theme homepage](http://www.exaitheme.com/)
...
* Clone the git repo - `git clone git://github.com/retlehs/exai.git` - or [download it](https://github.com/retlehs/exai/zipball/master)
